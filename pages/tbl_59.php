     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">Proclaimed Protected Areas under NIPAS, Region 10</option>
...
<!--/ end -->
  <div class="dropdown">
      ...
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl59-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

      <button class="btn btn-default btn btn-md"  data-toggle="modal" data-target="#tbl59-total"  style="background:#FE4A49; color:white; height:40px;"><span class="fa fa-calculator"></span> Total</button>
     
      <a href="report/tbl59.php">
...
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Proclaimed Protected Areas under NIPAS, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"><small>Name of Protected Area</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>Location</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>PA Area (ha)</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>Bufferzone Area(ha)</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>Total Area (ha)</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>Proclamation No. (Date)</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>Legislation No. (Date)</small> </th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM Proclaimed_Protected_Areas_under_NIPAS");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Proclaimed-Protected-Areas-under-NIPAS-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['Province']; ?></td>
                                <td><?php echo $row['Name_of_protected_area']; ?></td>
                                <td><?php echo $row['Location']; ?></td>
                                <td><?php echo number_format($row['Pa']); ?></td>
                                <td><?php echo number_format($row['Bufferzone']); ?></td>
                                <td><?php echo number_format($row['Total_area_ha']); ?></td>
                                <td><?php echo $row['Proclamation_no_date']; ?></td>
                                <td><?php echo $row['Legislation_no_date']; ?></td>
