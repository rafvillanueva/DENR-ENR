     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">Land Disposition Issued (Residential & Agricultural), By Province, Region 10</option>
...
<!--/ end -->
       <div class="dropdown">
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl42-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

     
      <a href="report/tbl42.php">
...
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Land Disposition Issued (Residential & Agricultural), By Province, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        ...
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"><small>Total Residential Patents Issued Patents Issued (No.)</small> </th>
                            <th style="background-color:#FE4A49; color:white;"><small>Total Residential Patents Issued Lot (ha)</small></th>
                            <th style="background-color:#FE4A49; color:white;"><small>Total Agricultural Patents Issued Patents Issued (No.)</small></th>
                            <th style="background-color:#FE4A49; color:white;"><small>Total Agricultural Patents Issued Lot (ha)</small></th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM land_disposition_issued ORDER BY Province ASC");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Land-Disposition-Issued-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['Province']; ?></td>
                                <td><?php echo $row['Total_Residential_Patents_Issued_Patents_issued_no']; ?></td>
                                <td><?php echo $row['Total_Residential_Patents_Issued_Lot_ha']; ?></td>
                                <td><?php echo $row['Total_Agricultural_Patents_Issued_Patents_issued_no']; ?></td>
                                <td><?php echo $row['Total_Agricultural_Patents_Issued_Lot_ha']; ?></td>
