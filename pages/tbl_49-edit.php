...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM ngp_seedling_planted WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM ngp_seedling_planted WHERE id = '$id'");
    header("location:Seedling-Planted");
}
?>
...
mysqli_query($conn,"UPDATE ngp_seedling_planted set province='$province',number_of_seedlings_planted='$number_of_seedlings_planted',year='$year' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Seedling-Planted'</script>";
            ...
            <div class="panel-heading" style="letter-spacing:2px; font-size:20px; font-weight: bold;"><img src="img/Info Squared_96px.png"  height="40px" width="40px">EDIT RECORD</div>
                <div class="panel-body">
                       <form method="POST" class="form-horizontal" autocomplete="off">
                              ...
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>No. of Seedling planted</small></label>
                                       <div class="col-sm-10">          
