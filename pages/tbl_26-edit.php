...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM existing_flgla WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM existing_flgla WHERE id = '$id'");
    header("location:Existing_FLGLA");
}
?>
...
mysqli_query($conn,"UPDATE existing_flgla set Penro='$Penro',Cenro='$Cenro',Municipality_City='$Municipality_City',Barangay='$Barangay',Name_of_instrument='$Name_of_instrument',Area_ha='$Area_ha',Status='$Status' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Existing_FLGLA'</script>";
