     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">NGP: Seedlings Planted, By Commodity, Region 10</option>
...
<!--/ end -->
  <div class="dropdown">
      ...
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl51-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

     
      <a href="report/tbl51.php">
...
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">NGP: Seedlings Planted, By Commodity, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> Commodity</th>
                            <th style="background-color:#FE4A49; color:white;"> No. of Commodity/Seedlings Planted</th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM ngp_seedlings_planted_by_commodity order by year Asc");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Seedling-Planted-by-Commodity-edit?id=<?= $row['id'] ?>';" class="record">
