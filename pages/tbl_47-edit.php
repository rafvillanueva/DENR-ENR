...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM ngp_area_planted WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM ngp_area_planted WHERE id = '$id'");
    header("location:NGP-Area-Planted");
}
?>
...
mysqli_query($conn,"UPDATE ngp_area_planted set province='$province',area_ha='$area_ha',year='$year' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='NGP-Area-Planted'</script>";
