...
<?php
	...
	header("Content-Disposition: attachment; filename=Forest Land Use Plan Formulation and Adoption / Bukidnon.xls");  
	...
	$output .="
		<table>
			<h2 style='color:#008B8B;'>ENR Profile : Forest Land Use Plan Formulation and Adoption / Bukidnon, Region 10</h2>
			<thead>
	...
	$output .= "
				<tr>
					<td><center><b>Bukidnon Total</b></center></td>
					<th></th>
					<th>".$B_1."</th>
					<th>".$B_2."</th>
					<th>".$B_3."</th>
