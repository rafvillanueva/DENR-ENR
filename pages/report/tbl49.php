...
include('../../config/dbcon.php');
    ...
    $result = mysqli_query($conn,"SELECT sum(number_of_seedlings_planted) FROM ngp_seedling_planted WHERE province='Bukidnon'") or die(mysql_error());
        while ($rows = mysqli_fetch_array($result)) {
		$B_show1=number_format($rows['sum(number_of_seedlings_planted)']);
        }
    ...
    $result = mysqli_query($conn,"SELECT sum(number_of_seedlings_planted) FROM ngp_seedling_planted WHERE province='Camiguin'") or die(mysql_error());
        while ($rows = mysqli_fetch_array($result)) {
		$C_show1=number_format($rows['sum(number_of_seedlings_planted)']);
        }
    ...
    $result = mysqli_query($conn,"SELECT sum(number_of_seedlings_planted) FROM ngp_seedling_planted WHERE province='Lanao del Norte'") or die(mysql_error());
        while ($rows = mysqli_fetch_array($result)) {
		$Lanao_show1=number_format($rows['sum(number_of_seedlings_planted)']);
        }
    ...
    $result = mysqli_query($conn,"SELECT sum(number_of_seedlings_planted) FROM ngp_seedling_planted WHERE province='Lake Lanao WPDP'") or die(mysql_error());
        while ($rows = mysqli_fetch_array($result)) {
		$Lake_show1=number_format($rows['sum(number_of_seedlings_planted)']);
        }
    ...
    $result = mysqli_query($conn,"SELECT sum(number_of_seedlings_planted) FROM ngp_seedling_planted WHERE province='Misamis Occidental '") or die(mysql_error());
        while ($rows = mysqli_fetch_array($result)) {
		$Misocc_show1=number_format($rows['sum(number_of_seedlings_planted)']);
        }
    ...
    $result = mysqli_query($conn,"SELECT sum(number_of_seedlings_planted) FROM ngp_seedling_planted WHERE province='Misamis Oriental'") or die(mysql_error());
        while ($rows = mysqli_fetch_array($result)) {
		$Misor_show1=number_format($rows['sum(number_of_seedlings_planted)']);
        }
...
<?php
	...
	header("Content-Disposition: attachment; filename=NGP: Seedling Planted By Year.xls");  
	...
	$output .="
		<table>
			<h3 style='color:#008B8B;'>ENR Profile : NGP Seedling Planted, By Year, Region 10</h3>
			<thead> <br>
				<tr style='color:#008B8B;'>
					<th><h3>Province</h3></th>
					<th><h3>Number of Seedling planted</h3></th>
					<th><h3>Year</h3></th>	
				</tr>
	...
	$query = $conn->query("SELECT * FROM `ngp_seedling_planted` where province='Bukidnon'") or die(mysqli_errno());
	...
	$query = $conn->query("SELECT * FROM `ngp_seedling_planted` where province='Camiguin'") or die(mysqli_errno());
	while($fetch = $query->fetch_array()){
	...
	$query = $conn->query("SELECT * FROM `ngp_seedling_planted` where province='Lanao del Norte'") or die(mysqli_errno());
	while($fetch = $query->fetch_array()){
	...
	$query = $conn->query("SELECT * FROM `ngp_seedling_planted` where province='Lake Lanao WPDP'") or die(mysqli_errno());
	while($fetch = $query->fetch_array()){
	...
	$query = $conn->query("SELECT * FROM `ngp_seedling_planted` where province='Misamis Occidental'") or die(mysqli_errno());
	while($fetch = $query->fetch_array()){
	...
	";
		...
		$query = $conn->query("SELECT * FROM `ngp_seedling_planted` where province='Misamis Oriental'") or die(mysqli_errno());
	while($fetch = $query->fetch_array()){
