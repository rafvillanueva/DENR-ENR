...
<?php
	...
	header("Content-Disposition: attachment; filename=Existing Tree Farm Lease Agreement TFLA.xls");  
	...
	$output .="
		<table>
			<h2 style='color:#008B8B;'>ENR Profile : Existing Tree Farm Lease Agreement (TFLA), Region 10</h2>
			<thead> <br>
	...
	$query = $conn->query("SELECT * FROM `existing_tfla` ORDER BY Penro ASC") or die(mysqli_errno());
