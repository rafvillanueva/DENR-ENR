...
<?php
	...
	header("Content-Disposition: attachment; filename=Existing Forest Land Grazing Lease Agreement FLGLA.xls");  
	...
	$output .="
		<table>
			<h2 style='color:#008B8B;'>ENR Profile : Existing Forest Land Grazing Lease Agreement (FLGLA), Region 10</h2>
			<thead> <br>
	...
	$query = $conn->query("SELECT * FROM `existing_flgla` ORDER BY Penro ASC") or die(mysqli_errno());
