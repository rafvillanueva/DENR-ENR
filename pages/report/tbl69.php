...
<?php
	...
	header("Content-Disposition: attachment; filename=Watershed Vulnerability Assessment Region 10.xls");  
	...
	$output .="
		<table>
			<h2 style='color:#008B8B;'>ENR Profile : Watershed Vulnerability Assessment, Region 10</h2>
			<thead> <br>
	...
	$query = $conn->query("SELECT * FROM `Watershed_Vulnerability_Assessment` ORDER BY Province ASC") or die(mysqli_errno());
