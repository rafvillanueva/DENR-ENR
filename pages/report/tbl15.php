...
<?php
	...
	header("Content-Disposition: attachment; filename=Classified Minor Rivers.xls");  
	...
	$output .="
		<table>
			<h2 style='color:#008B8B;'>ENR Profile : Classified Minor Rivers, Region 10</h2>
			<thead> <br>
	...
	$query = $conn->query("SELECT * FROM `classified_minor_rivers`") or die(mysqli_errno());
