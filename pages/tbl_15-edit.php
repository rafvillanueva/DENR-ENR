        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Classified-Minor-Rivers">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM classified_minor_rivers WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM classified_minor_rivers WHERE id = '$id'");
    header("location:Classified-Minor-Rivers");
}
?>
...
mysqli_query($conn,"UPDATE classified_minor_rivers set Name_Rivers='$Name_Rivers',Category='$Category',Classification='$Classification',Location='$Location',Exit_point='$Exit_point' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Classified-Minor-Rivers'</script>";
