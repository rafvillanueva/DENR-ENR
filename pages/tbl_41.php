     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">Land Classification and Distribution in hectares, Region 10</option>
...
<!--/ end -->
       <div class="dropdown">
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl41-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

     
      <a href="report/tbl41.php">
 ...
 <br>     
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Land Classification and Distribution in hectares, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> <small>Total Land Area</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Certified Alienable and Disposable Land</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Total Forestland</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Unclassified Forestland</small></th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM Land_Classification_and_Distribution");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Land-Classification-and-Distribution-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['Province']; ?></td>
                                <td><?php echo $row['Total_land_area']; ?></td>
                                <td><?php echo $row['Certified_alienable_and_Disposable_land']; ?></td>
                                <td><?php echo $row['Total_forestland']; ?></td>
                                <td><?php echo $row['Unclassified_forestland']; ?></td>
