     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">Classified Coastal Waters/Bay & Lakes, Region 10</option>
...
<!--/ end -->
      ...
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl13-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>


      <a href="report/tbl13.php">
 ...
 <br>     
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Classified Coastal Waters/Bay & Lakes, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> Name of Coastal <small>(Waters/Bay and Lakes)</small></th>
                            <th style="background-color:#FE4A49; color:white;"> Category</th>
                            <th style="background-color:#FE4A49; color:white;"> Classification</th>
                            <th style="background-color:#FE4A49; color:white;"> Location</th>
                            <th style="background-color:#FE4A49; color:white;"> Exit point</th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM classified_coastal_wbl");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Classified-Coastal-WBL-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['Coastal_name_wbl']; ?></td>
