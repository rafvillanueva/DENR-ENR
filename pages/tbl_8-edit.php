...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM baseline_for_csc WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM baseline_for_csc WHERE id = '$id'");
    header("location:Baseline-CSC");
}
?>
...
if (isset($_POST['x-changes'])){
  ...
  mysqli_query($conn,"UPDATE baseline_for_csc set OperatingUnit='$OperatingUnit',Within_CBFM_Area_No='$Within_CBFM_Area_No',Within_CBFM_Area_ha='$Within_CBFM_Area_ha',DENR_Jurisdiction_Area_No='$DENR_Jurisdiction_Area_No',DENR_Jurisdiction_ha='$DENR_Jurisdiction_ha',Devolved_to_LGUs_No='$Devolved_to_LGUs_No',Devolved_to_LGUs_ha='$Devolved_to_LGUs_ha' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Baseline-CSC'</script>";
    ...
    <div class="panel panel-default">
            <div class="panel-heading" style="letter-spacing:2px; font-size:20px; font-weight: bold;"><img src="img/Info Squared_96px.png"  height="40px" width="40px">EDIT RECORD</div>
                ...
                <div class="form-group col-xs-6" style="margin-left:5px;">
                  <label style="letter-spacing:2px;"><small>Within CBFM Area (Area ha)</small></label>
                ...
                <div class="form-group col-xs-6">
                  <label style="letter-spacing:2px;"><small>DENR Jurisdiction (No.)</small></label>
                ...
                <div class="form-group col-xs-6" style="margin-left:5px;">
                  <label style="letter-spacing:2px;"><small>DENR Jurisdiction Area (ha)</small></label>
                ...
                <div class="form-group col-xs-6" style="margin-left:5px;">
                  <label style="letter-spacing:2px;"><small>Devolved to LGUs Area (ha)</small></label>
                ...
                <div class="form-group col-xs-12" style="margin-top:-10px; margin-top:0.3px; width:967px;">
