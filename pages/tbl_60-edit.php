        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Status-of-Community-Resource-Management-Framework">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM Status_of_Community_Resource_Management_Framework WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM Status_of_Community_Resource_Management_Framework WHERE id = '$id'");
    header("location:Status-of-Community-Resource-Management-Framework");
} 
?>
...
mysqli_query($conn,"UPDATE Status_of_Community_Resource_Management_Framework set OperatingUnit='$OperatingUnit',No_of_CBFMA='$No_of_CBFMA',CBFMA_With_No_CRMF='$CBFMA_With_No_CRMF',CBFMA_With_CRMF_Needs_Updating='$CBFMA_With_CRMF_Needs_Updating',CBFMA_With_Updated_CRMF='$CBFMA_With_Updated_CRMF',CBFMA_With_Affirmed_CRMF='$CBFMA_With_Affirmed_CRMF' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Status-of-Community-Resource-Management-Framework'</script>";
                       ...
                       <form method="POST" class="form-horizontal" autocomplete="off">
                              ...
                              <div class="form-group">
                               <label class="control-label col-sm-2" for="pwd"><small>Operating Unit</small></label>
                                       <div class="col-sm-10">          
                                          <select name="OperatingUnit" class="form-control" required>
                              ...
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>No. of CBFMA</small></label>
                                       <div class="col-sm-10">          
                                          <input name="No_of_CBFMA"  type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" required value="<?= $row['No_of_CBFMA']; ?>">
                                       </div>
                              </div>

                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>CBFMA With No CRMF</small></label>
                                       <div class="col-sm-10">          
                                          <input name="CBFMA_With_No_CRMF" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" required value="<?= $row['CBFMA_With_No_CRMF']; ?>">
                                       </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>CBFMA With CRMF Needs Updating</small></label>
                                       <div class="col-sm-10">          
                                          <input name="CBFMA_With_CRMF_Needs_Updating" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" class="form-control" required value="<?= $row['CBFMA_With_CRMF_Needs_Updating']; ?>">
                                       </div>
                              </div>                       

                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>CBFMA With Updated CRMF</small></label>
                                       <div class="col-sm-10">          
                                          <input name="CBFMA_With_Updated_CRMF" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" required value="<?= $row['CBFMA_With_Updated_CRMF']; ?>">
                                       </div>
                              </div>

                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>CBFMA With Affirmed CRMF</small></label>
                                       <div class="col-sm-10">          
                                          <input name="CBFMA_With_Affirmed_CRMF" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" class="form-control" required value="<?= $row['CBFMA_With_Affirmed_CRMF']; ?>">
                                       </div>
                              </div>    
