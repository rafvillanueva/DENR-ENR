     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">Forest Land Use Plan Formulation and Adoption, Region 10</option>
...
<!--/ end -->
       <div class="dropdown">
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl35-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

     


    <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" style="background:#4AD7D1; color:white; height:40px;"><span class="fa fa-file-excel-o"></span>
      Export
    <span class="caret"></span></button>
    <ul class="dropdown-menu">
      <li><a href="report/tbl35-allprovince.php">All Province</a></li>
      <li><a href="report/tbl35-Bukinon.php">Bukidnon</a></li>
      <li><a href="report/tbl35-Camiguin.php">Camiguin</a></li>
      <li><a href="report/tbl35-Lanao.php">Lanao del Norte</a></li>
      <li><a href="report/tbl35-Misocc.php">Misamis Occidental</a></li>
      <li><a href="report/tbl35-Misor.php">Misamis Oriental</a></li>
    </ul>
  </div>
 ...
 <br>     
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Forest Land Use Plan Formulation and Adoption, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> <small>Province</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>City/Municipality</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>FLUP Formulated</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>FLUP Adopted</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Total Forestland within LGU(ha)</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Total Area for FLUP (Ha)</small></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM Forest_land_upfa");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Forest-land-UPFA-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['Province']; ?></td>
                                <td><?php echo $row['City_Municipality']; ?></td>
                                <td><?php echo $row['Flup_Formulated']; ?></td>
                                <td><?php echo $row['Flup_Adopted']; ?></td>
                                <td><?php echo $row['Total_Forestland_with_LGU']; ?></td>
                                <td><?php echo $row['Total_Area_For_Flup']; ?></td>
