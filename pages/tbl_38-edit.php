        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Integrated-Watershed-MPP">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM Inregrated_watershed_management_plan_prepared WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM Inregrated_watershed_management_plan_prepared WHERE id = '$id'");
    header("location:Integrated-Watershed-MPP");
}
?>
...
mysqli_query($conn,"UPDATE Inregrated_watershed_management_plan_prepared set Province='$Province',Name_of_watershed='$Name_of_watershed',City_Municipality='$City_Municipality',Area_ha='$Area_ha',Year='$Year' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Integrated-Watershed-MPP'</script>";
