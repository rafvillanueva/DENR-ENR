     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">Major River Basins, Region 10</option>
...
<!--/ end -->
       <div class="dropdown">
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl45-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

     
      <a href="report/tbl45.php">
...
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Major River Basins, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> River Basins</th>
                            <th style="background-color:#FE4A49; color:white;"> Area (ha)</th>
                            <th style="background-color:#FE4A49; color:white;"> Provinces Convered</th>
                            <th style="background-color:#FE4A49; color:white;"> City/Municipality Covered</th>
                            <th style="background-color:#FE4A49; color:white;"> River Tributary</th>
                            <th style="background-color:#FE4A49; color:white;"> Outlet</th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM major_river_basins");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Major-River-Basins-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['River_basins']; ?></td>
                                <td><?php echo number_format($row['area_ha']); ?></td>
                                <td><?php echo $row['provinces_covered']; ?></td>
                                <td><?php echo $row['city_municipality_covered']; ?></td>
                                <td><?php echo $row['river_tributary']; ?></td>
