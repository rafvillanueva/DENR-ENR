        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Classified-Major-Rivers">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM classified_major_rivers WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM classified_major_rivers WHERE id = '$id'");
    header("location:Classified-Major-Rivers");
}
?>
...
mysqli_query($conn,"UPDATE classified_major_rivers set Name_Rivers='$Name_Rivers',Category='$Category',Classification='$Classification',Location='$Location',Exit_point='$Exit_point' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Classified-Major-Rivers'</script>";
                              ...
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>Name of Rivers</small></label>
                                       <div class="col-sm-10">          
                                          ...
                                          <input name="Category" type="hidden" required value="<?= $row['Category']; ?>">
