        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Apprehended-Rattan-Poles">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM apprehended_rattan_poles WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM apprehended_rattan_poles WHERE id = '$id'");
    header("location:Apprehended-Rattan-Poles");
}
?>
...
mysqli_query($conn,"UPDATE apprehended_rattan_poles set Volume_inLinealMeters='$Volume_inLinealMeters',EstValue='$EstValue',Year='$Year',OperatingUnit='$OperatingUnit' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Apprehended-Rattan-Poles'</script>";
