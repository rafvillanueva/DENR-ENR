        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Confiscated-Forest-Products">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM confiscated_forest_products WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM confiscated_forest_products WHERE id = '$id'");
    header("location:Confiscated-Forest-Products");
}
?>
...
mysqli_query($conn,"UPDATE confiscated_forest_products set Volume_inBoardFeet='$Volume_inBoardFeet',EstValue='$EstValue',Year='$Year',OperatingUnit='$OperatingUnit' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Confiscated-Forest-Products'</script>";
