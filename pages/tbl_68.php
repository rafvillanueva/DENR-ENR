...
<!--/ end -->
      ...
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl68-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>




      <a href="report/tbl68.php">
 ...
 <br>     
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri'">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">Watershed Supporting River Irrigation System of NIA, Region 10</l> </b>
<br>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example" style="margin-top:-40px;">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> <small>Regional Irrigation System (RIS)</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Province</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Municipality</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>Watershed Area (ha)</small></th>
                            <th style="background-color:#FE4A49; color:white;"> <small>RIS Service Area (ha)</small></th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM Watershed_Supporting_River_Irrigation_System_of_NIA");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='Watershed-Supporting-River-Irrigation-System-of-NIA-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['Name_of_Watershed']; ?></td>
                                <td><?php echo $row['Regional_Irrigation_System_RIS']; ?></td>
                                <td><?php echo $row['Province']; ?></td>
                                <td><?php echo $row['Municipality']; ?></td>
                                <td><?php echo $row['Watershed_Area_ha']; ?></td>
                                <td><?php echo $row['RIS_Service_Area_ha']; ?></td>
