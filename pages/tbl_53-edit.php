        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Validated-Project-Sites">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM ngp_validated_project_sites WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM ngp_validated_project_sites WHERE id = '$id'");
    header("location:Validated-Project-Sites");
}
?>
...
mysqli_query($conn,"UPDATE ngp_validated_project_sites set penro_cenro_pa='$penro_cenro_pa',area_ha='$area_ha',no_of_seedlings_validated='$no_of_seedlings_validated',no_of_seedlings_planted='$no_of_seedlings_planted',no_of_seedlings_contracted='$no_of_seedlings_contracted',survival='$survival' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Validated-Project-Sites'</script>";
            ...
            <div class="panel-heading" style="letter-spacing:2px; font-size:20px; font-weight: bold;"><img src="img/Info Squared_96px.png"  height="40px" width="40px">EDIT RECORD</div>
                <div class="panel-body">
                       <form method="POST" class="form-horizontal" autocomplete="off">
                              ...
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>PENRO/CENRO/PA</small> </label>
                                       <div class="col-sm-10">          
                                          <input name="penro_cenro_pa" type="text" class="form-control" required value="<?= $row['penro_cenro_pa']; ?>">
                                       </div>
                              </div>
                              ...
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>No. of Seedling Validated</small></label>
                                       <div class="col-sm-10">          
                                          <input name="no_of_seedlings_validated" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" class="form-control" required value="<?= $row['no_of_seedlings_validated']; ?>">
                                       </div>
                              </div>

                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>No. of Seedlings Planted</small> </label>
                                       <div class="col-sm-10">          
                                          <input name="no_of_seedlings_planted" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" class="form-control" required value="<?= $row['no_of_seedlings_planted']; ?>">
                                       </div>
                              </div>

                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>No. of Seedlings Contracted</small> </label>
                                       <div class="col-sm-10">          
                                          <input name="no_of_seedlings_contracted" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" class="form-control" required value="<?= $row['no_of_seedlings_contracted']; ?>">
                                       </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>Survival Rate</small></label>
                                       <div class="col-sm-10">          
                                          <input name="survival" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" class="form-control" required value="<?= $row['survival']; ?>">
                                       </div>
                              </div>
