        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li style="border: 0px;"><br>
                    <a href="Watershed-Supporting-River-Irrigation-System-of-NIA">
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $edit = mysqli_query($conn, "SELECT * FROM Watershed_Supporting_River_Irrigation_System_of_NIA WHERE id = '$id'");
  $row = mysqli_fetch_array($edit);
}elseif(isset($_GET['del'])){
    $id = $_GET['del'];
    $sql = mysqli_query($conn, "DELETE FROM Watershed_Supporting_River_Irrigation_System_of_NIA WHERE id = '$id'");
    header("location:Watershed-Supporting-River-Irrigation-System-of-NIA");
} 
?>
...
mysqli_query($conn,"UPDATE Watershed_Supporting_River_Irrigation_System_of_NIA set Name_of_Watershed='$Name_of_Watershed',Regional_Irrigation_System_RIS='$Regional_Irrigation_System_RIS',Province='$Province',Municipality='$Municipality',Watershed_Area_ha='$Watershed_Area_ha',RIS_Service_Area_ha='$RIS_Service_Area_ha' where id='$id'");
echo "<script>alert('Success! Record Updated.'); window.location='Watershed-Supporting-River-Irrigation-System-of-NIA'</script>";
            ...
            <div class="panel-heading" style="letter-spacing:2px; font-size:20px; font-weight: bold;"><img src="img/Info Squared_96px.png"  height="40px" width="40px">EDIT RECORD</div>
                  <div class="panel-body">
                       <form method="POST" class="form-horizontal" autocomplete="off">
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>Name of Watershed</small></label>
                                       <div class="col-sm-10">          
                                          <input name="Name_of_Watershed" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" type="text" class="form-control" required value="<?= $row['Name_of_Watershed']; ?>">
                                       </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>Regional Irrigation System (RIS)</small></label>
                                       <div class="col-sm-10">          
                                          <input name="Regional_Irrigation_System_RIS" type="text" class="form-control" required value="<?= $row['Regional_Irrigation_System_RIS']; ?>">
                                       </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>Municipality</small></label>
                                       <div class="col-sm-10">          
                                          <input name="Municipality" type="text" class="form-control" required value="<?= $row['Municipality']; ?>">
                                       </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>Watershed Area (ha)</small></label>
                                       <div class="col-sm-10">          
                                          <input name="Watershed_Area_ha" type="text" class="form-control" required value="<?= $row['Watershed_Area_ha']; ?>">
                                       </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-sm-2" for="pwd"><small>RIS Service Area (ha)</small></label>
                                       <div class="col-sm-10">          
                                          <input name="RIS_Service_Area_ha" type="text" class="form-control" required value="<?= $row['RIS_Service_Area_ha']; ?>">
                                       </div>
                              </div>
