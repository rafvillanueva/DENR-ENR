     ...
     <div class="row1">
                      <label class="col-sm-12" style="font-weight:bold; margin-left:-15px; letter-spacing:1px; font-family:Calibri;font-size: 18px; color:#FE4A49;"> SELECT A RECORDS</label>
                            ...
                            <select class="form-control" onchange="myFunction()" id="mySelect" required style="border:1px solid gray; letter-spacing: 2px; font-size:17px;">
                              ...
                              <option selected value="1" class="title-op">NIPAS and Locally-managed Marine Protected Areas, Region 10</option>
...
<!--/ end -->
  <div class="dropdown">
      ...
      <button class="btn btn-default btn btn-md" data-toggle="modal" data-target="#tbl54-add" style="height:40px; background:#001730; color:white; opacity:0.8;"><span class="fa fa-plus"></span> Add</button>

      <button class="btn btn-default btn btn-md"  data-toggle="modal" data-target="#tbl54-total"  style="background:#FE4A49; color:white; height:40px;"><span class="fa fa-calculator"></span> Total</button>
     
      <a href="report/tbl54.php">
...
<br>
<b style="letter-spacing:1px; font-size:20px; font-family:'Calibri';">Title Selected : <l style="text-decoration:underline; color:#20B2AA;">NIPAS and Locally-managed Marine Protected Areas, Region 10</l> </b>
<br>
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <br>
                        <tr>
                            ...
                            <th style="background-color:#FE4A49; color:white;"> Location / Province</th>
                            <th style="background-color:#FE4A49; color:white;"> No. of MPAs</th>
                            <th style="background-color:#FE4A49; color:white;"> Total Area (ha) </th>
                            <th style="background-color:#FE4A49; color:white;"> Field Status</th>
                            <th style="background-color:#FE4A49; color:white;"> Year</th>
                    ...
                    <tbody>
                        ...
                        <?php
                        include('connect.php');
                        $result = $db->prepare("SELECT * FROM Nipas_and_locally_managed_marine_protected_areas ORDER BY year ASC");
                        $result->execute();
                        for($i=0; $row = $result->fetch(); $i++){
                            ?>

                        <tr onclick="window.location='NIPAS-and-Locally-Managed-Marine-Protected-Areas-edit?id=<?= $row['id'] ?>';" class="record">
                                <td><img src="img/Settings_96px.png" height="32" style="margin-left:20px;"></td>
                                <td><?php echo $row['location_Province']; ?></td>
                                <td><?php echo $row['No_of_MPAs']; ?></td>
                                <td><?php echo $row['total_area_ha']; ?></td>
